...
public class CategoriaServiceImpl implements CategoriaService {
    ...
    public CategoriaDTO guardar(CategoriaDTO categoriaDTO) {
        CategoriaEntity categoriaEntity = categoriaMapper.categoriaDTOACategoriaEntity(categoriaDTO);
    ...
    public CategoriaDTO buscar(Long id) {
        CategoriaEntity categoriaEntity = categoriaRepository.findById(id).orElseThrow(() -> new
    ...
    public CategoriaDTO editar(CategoriaDTO categoriaDTO) {
        CategoriaEntity categoriaEntity = categoriaRepository.findById(categoriaDTO.getId()).get();
